...
func (ds *DiscoveryService) discover() {
	...
	discovery.Advertise(context.Background(), routingDiscovery, ds.opts.RendezvousPoint, discoveryopt.TTL(time.Minute * 1))

	// TODO: how long does this block etc.? docs don't tell anything
	peerChan, err := routingDiscovery.FindPeers(context.Background(), ds.opts.RendezvousPoint)
	if err != nil {
